...
class Lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._tune_range = Range(87.7, 101.1, 0.2, 101.1, 200)
        ...
        self.connect((self.iio_pluto_source_0, 0), (self.low_pass_filter_1, 0))
    ...
    def set_tune(self, tune):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.tune, 480000)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, 100000, 50000, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0_0.set_frequency_range(101100000, self.samp_rate)
